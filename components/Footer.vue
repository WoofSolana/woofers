...
<!--         <img src="~/assets/svg/woof.svg" alt="" class="w-30 mt-8">
        ...
        <p class="copyright text-xs font-light text-gray-400">WOOF - Copyright 2021</p>
        <div class="max-w-md flex flex-row gap-4 text-center justify-center items-center">
            ...
            <a href='https://www.facebook.com/woofsolana' target="_blank">
                <svg xlmns='http://www.w3.org/2000/svg' width="24" height="24" viewBox="0 0 24 24" class="fill-current" >
